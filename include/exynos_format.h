...
enum {
    ...
    HAL_PIXEL_FORMAT_EXYNOS_ARGB_8888           = 0x11E,
    HAL_PIXEL_FORMAT_YCbCr_420_SP_M             = 0x11F,
    HAL_PIXEL_FORMAT_EXYNOS_YV12_M                  = 0x120,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_P_M       = 0x121,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_P         = 0x122,
    HAL_PIXEL_FORMAT_EXYNOS_YCrCb_420_SP_M      = 0x123,
    HAL_PIXEL_FORMAT_EXYNOS_YCrCb_420_SP_M_FULL = 0x124,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SP_M      = 0x125,
    HAL_PIXEL_FORMAT_YV12_M                     = 0x126,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SP_M_TILED = 0x127,
