...
//#endif
        ...
        base(0), base1(0), base2(0)
    {
        ...
        numFds = sNumFds - 2;
        ALOGD("%s gralloc numInts+2=%d numIntsDelta=%d", __FUNCTION__, numInts, numIntsDelta);
    }
        ...
        base(0), base1(0), base2(0)
    {
        ...
        numFds = sNumFds - 1;
        ALOGD("%s gralloc numInts+1=%d numIntsDelta=%d", __FUNCTION__, numInts, numIntsDelta);
    }
